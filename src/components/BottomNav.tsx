...
export const BottomNav: React.FC<BottomNavProps> = ({
  ...
  return (
    <nav
      id="bottom-nav"
      className="md:hidden fixed bottom-0 left-0 right-0 z-50 bg-white border-t border-slate-200 w-full flex justify-around items-center select-none py-2 px-2"
      style={{
        position: 'fixed',
        bottom: 0,
        left: 0,
