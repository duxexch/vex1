...
export const TRANSLATIONS: Record<Language, TranslationSchema> = {
  ar: {
    ...
    inviteBtn: 'دعوة صديق',
    referralTitle: 'نظام الإحالات وفك التجميد عبر vex.deals',
    referralDesc: 'شارك رابطك المعتمد عبر vex.deals مع أصدقائك. عند تسجيل صديق يتم فك تجميد 10% من رصيدك المجمد وتحويله فورياً لرصيدك المتاح!',
    referralUnfreezeBadge: 'فك تجميد فوري 10% لكل إحالة نشطة',
  ...
  en: {
    ...
    referralTitle: 'Referrals & Balance Unlock via vex.deals',
    referralDesc: 'Share your verified link via vex.deals with friends. Every time a friend registers, 10% of your frozen balance is unlocked into available balance!',
    referralUnfreezeBadge: 'Instant 10% unfreeze per active referral',
  ...
  es: {
    ...
    referralTitle: 'Referidos y Desbloqueo vía vex.deals',
    referralDesc: 'Comparte tu enlace verificado de vex.deals con amigos. ¡Cada vez que un amigo se registra, el 10% de tu saldo congelado pasa a saldo disponible!',
    referralUnfreezeBadge: 'Desbloqueo instantáneo del 10% por referido activo',
  ...
  ru: {
    ...
    referralTitle: 'Реферальная система и разблокировка через vex.deals',
    referralDesc: 'Поделитесь проверенной ссылкой vex.deals с друзьями. При регистрации друга 10% замороженного баланса моментально переходит в доступный!',
    referralUnfreezeBadge: 'Мгновенная разблокировка 10% за активного реферала',
